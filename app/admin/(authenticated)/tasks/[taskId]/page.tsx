...
export default async function AdminTaskReviewPage({ params }: { params: Promise<{ taskId: string }> }) {
  ...
  return (
    <div className="animate-fade-up">
      <Link href="/admin/tasks" style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "var(--text-secondary)", textDecoration: "none", fontSize: 14, marginBottom: 24 }} className="hover:text-white">
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
            ...
            {task.submissions.length > 0 && (
              <a href={`/api/admin/tasks/${task.id}/bulk-download`} target="_blank" className="btn btn-secondary btn-sm" style={{ textDecoration: "none" }}>
